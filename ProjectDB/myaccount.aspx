<%@ Page Title="" Language="C#" MasterPageFile="~/Music.Master" AutoEventWireup="true" CodeBehind="myaccount.aspx.cs" Inherits="ProjectDB.WebForm2" %>
...
<nav class="navBar">
  ...
  <h1 class="h1Style" style="text-align: center;"> User Details</h1>
    <div id ="DIV" runat ="server"></div>
      <a style="text-align:center; padding:700px" href="/editaccount.aspx">Edit Account<a>
   </div>
</asp:Content>
